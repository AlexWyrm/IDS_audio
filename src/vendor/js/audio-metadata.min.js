!function (e) {
    if ("object" == typeof exports)module.exports = e(); else if ("function" == typeof define && define.amd)define(e); else {
        var f;
        "undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.AudioMetadata = e()
    }
}(function () {
    ...
    return function e(t, n, r) {
        ...
        1: [function (require, module, exports) {
            module.exports = {ogg: require("./src/ogg"), id3v1: require("./src/id3v1"), id3v2: require("./src/id3v2")}
        }, {"./src/id3v1": 2, "./src/id3v2": 3, "./src/ogg": 4}], 2: [function (require, module, exports) {
            ...
            module.exports = function (buffer) {
                ...
                try {
                    var offset = view.byteLength - 128 + 3, readAscii = utils.readAscii;
                    var title = readAscii(view, offset, 30), artist = readAscii(view, offset + 30, 30), album = readAscii(view, offset + 60, 30), year = readAscii(view, offset + 90, 4);
                    offset += 94;
                    var comment = readAscii(view, offset, 28), track = null;
                    offset += 28;
            ...
            module.exports = function (buffer) {
                ...
                function readFrame(offset) {
                    try {
                        ...
                        offset += 10;
                        if (id[0] !== "T") {
                            return {id: id, size: size + 10}
                        }
                        var encoding = view.getUint8(offset), data = "";
                        if (encoding <= 3) {
                            offset++;
                            if (encoding === 3) {
                        ...
                        return {id: id, size: size + 10, content: data}
                    } catch (e) {
                        return null
                    }
                }
                ...
                var endOfTags = offset + size, frames = {};
                while (offset < endOfTags) {
                    ...
                    if (id === "TXXX") {
                        var nullByte = frame.content.indexOf("\x00");
            ...
            module.exports = function (buffer) {
                ...
                function parsePage(offset, withPacket) {
                    ...
                    var numPageSegments = view.getUint8(offset + 26), segmentTable = utils.readBytes(view, offset + 27, numPageSegments), headerSize = 27 + numPageSegments;
                    if (!segmentTable.length) {
                        return null
                    }
                    var pageSize = headerSize + segmentTable.reduce(function (cur, next) {
                            return cur + next
                        }), length = headerSize + 1 + "vorbis".length, packetView = null;
                    if (withPacket) {
                        packetView = utils.createView(new ArrayBuffer(pageSize - length));
                        utils.readBytes(view, offset + length, pageSize - length, packetView)
                    }
                    return {pageSize: pageSize, packet: packetView}
                }

                function parseComments(packet) {
                    try {
                        var vendorLength = packet.getUint32(0, true), commentListLength = packet.getUint32(4 + vendorLength, true), comments = {}, offset = 8 + vendorLength, map = {tracknumber: "track"};
                        for (var i = 0; i < commentListLength; i++) {
                            var commentLength = packet.getUint32(offset, true), comment = utils.readUtf8(packet, offset + 4, commentLength), equals = comment.indexOf("="), key = comment.substring(0, equals).toLowerCase();
